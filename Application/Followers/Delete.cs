    ...
    public class Delete {
        ...
        public class Handler : IRequestHandler<Command> {
            ...
            public async Task<Unit> Handle(Command request, CancellationToken cancellationToken) {
                ...
                //Dont need to check for current user, because they have to be authenticated anyways
                //We do need to check target because User may incorrectly type a username
                if (target == null)
                    throw new RestException(HttpStatusCode.NotFound, new { User = "Not found" });

                //check to see if they are following a particular user
                ...
                //If they are not following, create relationship
                if (following != null) {
